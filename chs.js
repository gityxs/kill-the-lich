...
var cnItems = {
    ...
    "% of": "% 的",
    "[Automation] When an action is at its max level and has no downstream actions with sliders, it \n                automatically set the flow rate leading to it to 0%. This will apply recursively.": "[自动化]当一个动作处于最大水平并且没有滑块的下游动作时，它会自动将导致它的流量设置为0%。这将递归地应用。",
    ...
    "Illuminate": "照亮",
    "In addition, +2 max levels for Remember when this action levels.": "另外，+2最高等级为记住当这个行动水平。",
